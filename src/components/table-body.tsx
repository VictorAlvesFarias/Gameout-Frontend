...
const TableBody = componentSelector<keyof typeof bodyVariations, React.HTMLAttributes<React.HTMLAttributes<HTMLTableSectionElement>>, "className">(bodyVariations)
